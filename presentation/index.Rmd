---
title: "A Gentle Introduction to Parallel Computing for emLab"
author: Danielle Ferraro and Gavin McDonald <br>`r knitr::include_graphics("img/emlab_logo_cutout_w.png", dpi = .001)`
date: "<br>emLab Study Club<br>January 9, 2024"
output:
...
For short examples of how to use these R packages for parallel computing, see [sample_code.Rmd](https://github.com/danielleferraro/rladies-sb-parallel/blob/main/sample_code/sample_code.Rmd)<br>
